        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Jika pengguna memilih peran, tambahkan pengguna ke peran yang dipilih
                    if (!string.IsNullOrEmpty(Input.Role) && _roleManager.RoleExistsAsync(Input.Role).Result)
                    {
            ...
            // Jika kita sampai di sini, sesuatu gagal, tampilkan formulir kembali
            return Page();
        }
